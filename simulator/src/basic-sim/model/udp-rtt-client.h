...
public:
   ...
   * care) by this call.
   *
   * \warning If you have set the fill data for the rtt client using one of the
   * SetFill calls, this will undo those effects.
   *
   * \param dataSize The size of the rtt data you want to sent.
   */
   ...
   * \param dataSize The desired size of the resulting rtt packet data.
   */
   ...
   * \param dataSize The desired size of the final rtt data.
   */
