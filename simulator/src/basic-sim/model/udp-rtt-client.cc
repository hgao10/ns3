...
UdpRttClient::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::UdpRttClient")
    ...
    .AddAttribute ("MaxPackets", 
                   ...
                   UintegerValue (100),
                   MakeUintegerAccessor (&UdpRttClient::m_count),
    ...
    .AddAttribute ("PacketSize", "Size of rtt data in outbound packets",
                   UintegerValue (100),
                   MakeUintegerAccessor (&UdpRttClient::SetDataSize,
                                         &UdpRttClient::GetDataSize),
                   MakeUintegerChecker<uint32_t> ())
    .AddTraceSource ("Tx", "A new packet is created and is sent",
                     MakeTraceSourceAccessor (&UdpRttClient::m_txTrace),
                     "ns3::Packet::TracedCallback")
    .AddTraceSource ("Rx", "A packet has been received",
                     MakeTraceSourceAccessor (&UdpRttClient::m_rxTrace),
                     "ns3::Packet::TracedCallback")
    .AddTraceSource ("TxWithAddresses", "A new packet is created and is sent",
                     MakeTraceSourceAccessor (&UdpRttClient::m_txTraceWithAddresses),
                     "ns3::Packet::TwoAddressTracedCallback")
    .AddTraceSource ("RxWithAddresses", "A packet has been received",
                     MakeTraceSourceAccessor (&UdpRttClient::m_rxTraceWithAddresses),
                     "ns3::Packet::TwoAddressTracedCallback")
  ;
  return tid;
}
...
void 
UdpRttClient::SetDataSize (uint32_t dataSize)
{
  NS_LOG_FUNCTION (this << dataSize);

  //
  // If the client is setting the rtt packet data size this way, we infer
...
uint32_t 
UdpRttClient::GetDataSize (void) const
{
  NS_LOG_FUNCTION (this);
  return m_size;
}
...
void 
UdpRttClient::SetFill (std::string fill)
{
...
void 
UdpRttClient::SetFill (uint8_t fill, uint32_t dataSize)
{
...
void 
UdpRttClient::SetFill (uint8_t *fill, uint32_t fillSize, uint32_t dataSize)
{
  ...
  if (m_dataSize)
    {
      ...
      //
      NS_ASSERT_MSG (m_dataSize == m_size, "UdpRttClient::Send(): m_size and m_dataSize inconsistent");
      NS_ASSERT_MSG (m_data, "UdpRttClient::Send(): m_dataSize but no m_data");
