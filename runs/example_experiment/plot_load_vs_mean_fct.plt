...
# Output
set output "pdf/plot_load_vs_mean_fct.pdf"
...
plot    \
        "data_random_schedule/fct_ns_mean.txt" using ($1 / 500):($2 / 1000000) title "Poisson schedule" w lp ls 1, \
        "data_random_schedule/fct_ns_mean.txt" using ($1 / 500):($2 / 1000000):($3 / 1000000) title "" w yerrorbars ls 1, \
        \
        "data_perfect_schedule/fct_ns_mean.txt" using ($1 / 500):($2 / 1000000) title "Perfect schedule" w lp ls 2, \
        "data_perfect_schedule/fct_ns_mean.txt" using ($1 / 500):($2 / 1000000):($3 / 1000000) title "" w yerrorbars ls 2, \
